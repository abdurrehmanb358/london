...
<main class="home">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 mt-4">
                <div class="card-body bg-gray">
                    <h6 class="card-title">Al Raya Hotel Apartments</h6>
                    <!-- Rating stars -->
                    <div class="rating text-warning">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                    ...
                    <div>
                        <p class="style" style="font-size: 12px; margin-top: -30px;">Price per adult on double/twin sharing basis</p>
                    </div>
                    <!-- Share icons -->
                    <p class="share-text" style="margin-top: -px;">Share</p>
                    <div class="icon-container">
                    ...
                    <!-- SELECT button -->
                    <button type="button" class="custom-button mt-3">Book Now</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-3" style="background-color:#fcfcfc; padding:30px;">
        <!-- Package Itinerary Content Here -->
    </div>
    ...
    <div class="container">
        <div class="container ">
            <form action="">
                <h1><span class="h2">Hotel Inquiry!</span></h1>
                <!-- Hotel Inquiry Form Content Here -->
            </form>
        </div>
    </div>
</main> --}}